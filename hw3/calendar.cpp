...
void Calendar::getDate(int *day, int *month, int *year)
{
  while(true)
  {
    ...
    if (!cin.getline(line, 80))
      cout << " is not a valid date." << endl << "Please try again." << endl;
    else // User entered something
    {
      ...
      if(*day >= 1 && *day <= 31 && *month >= 1 && *month <= 12
         && *year >= 1000 && *year <= 2017)
         break;
      cout << line2 << " is not a valid date." << endl << "Please try again." \
      << endl;
